<div class="space-y-4">
    ...
    <label class="flex flex-col">
        ...
        <textarea class="rounded-md shadow-sm border-slate-250 focus:ring-slate-300 focus:ring-opacity-50 focus:border-slate-300" name="message" rows="3">
            {{old('message',$consult->message)}}
        </textarea>
